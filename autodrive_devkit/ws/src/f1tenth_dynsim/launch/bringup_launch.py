...
def generate_launch_description() -> LaunchDescription:
    ...
    # usa o params do teu pacote se existir
    try:
        default_params_pkg  = get_package_share_directory('f1tenth_dynsim')
        default_params_path = os.path.join(default_params_pkg, 'config', 'nav2_params.yaml')
    except Exception:
        default_params_path = os.path.join(bringup_dir, 'params', 'nav2_params.yaml')
    ...
    declare_use_localization_cmd = DeclareLaunchArgument('use_localization', default_value='True')
